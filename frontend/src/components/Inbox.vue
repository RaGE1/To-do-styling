<template>
  <div id="inbox-wrapper">
    ...
    <router-link
      id="AddTask"
      class="flex max-w-3xl hover:text-bannercolor py-4"
      @mouseover.native="showCircle = true"
      @mouseleave.native="showCircle = false"
      to="/today"
    >
      <span
        class="text-bannercolor rounded-full w-4 h-4"
        :class="{ ['bg-bannercolor text-gray-50']: showCircle }"
      >
